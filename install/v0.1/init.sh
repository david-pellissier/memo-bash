# DEFAULT VALUES
INSTALL_DIR="/opt/memo-bash/"
PROGRAM_PATH="$INSTALL_DIR""MemoBash"
...
declare -A MAINCOMMANDS=( [--new]=1 [-n]=1 [--remove]=1 [-r]=1 [--find]=1 [-f]=1 [--export]=1 [-e]=1 [--print]=1 [-p]=1 [--help]=1)
DEFAULT_EXPORTFILE="memo_export.json"
HELPFILE="$INSTALL_DIR""help.txt"
mode=0
options=00
optionsVal=""
val=""
...
function processArg()
{
  ...
  case $1 in
    ...
    --help)
      print_help ;;
    *)
      echo Error: This parameter does not exist
      print_help ;;
